...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      "Experience high-fidelity audio with world-class active noise cancellation. Custom 40mm acoustic drivers deliver deep bass, crisp highs, and immersive spatial sound audio balance.",
    features: [
  ...
  },
  {
    ...
    description:
      "Unleash productivity and creative power with the UltraBook Pro. Features a stunning 3.5K OLED touch display, ultra-slim aluminum chassis, and peak multi-core processing performance.",
    features: [
  ...
  },
  {
    ...
    description:
      "Transform your home theater experience with quantum dot technology, delivering over a billion shades of realistic color and ultra-sharp contrast.",
    features: [
  ...
  },
  {
    ...
    description:
      "Track your health, workouts, and stay connected with a vibrant always-on AMOLED display and precision biometric sensors.",
    features: [
  ...
  },
  {
    ...
    description:
      "Keep watch over your home with crystal-clear 1080p Full HD video, color night vision, motion alerts, and two-way audio.",
    features: [
  ...
  },
  {
    ...
    description:
      "Hands-free cleaning for up to 60 days. LiDAR laser navigation builds precise 3D floor maps for deep carpet vacuuming and hard floor mopping.",
    features: [
  ...
  },
  {
    ...
    description:
      "Illuminate your living room or gaming setup with segmented RGBIC colors, music sync modes, and smart phone app customization.",
    features: [
  ...
  },
  {
    ...
    description:
      "Engineered for outdoor durability and urban style. Windproof shell, thermal reflective lining, and sealed storm zippers.",
    features: [
  ...
  },
  {
    ...
    description:
      "Featherweight knit mesh running sneakers with responsive memory foam cushioning for maximum joint comfort during road runs or gym workouts.",
    features: [
  ...
  },
  {
    ...
    description:
      "Spacious 35L capacity travel backpack with padded laptop sleeve, USB charging port passthrough, and hidden anti-theft back pocket.",
    features: [
  ...
  },
  {
    ...
    description:
      "Forged high-carbon German stainless steel knife blades with ergonomic full-tang handles and an acacia wooden storage block with built-in sharpener.",
    features: [
  ...
  },
  {
    ...
    description:
      "Craft cafe-quality lattes, cappuccinos, and espresso shots right at home with 20-bar Italian pump pressure and microfoam steam wand.",
    features: [
  ...
  },
  {
    ...
    description:
      "Enjoy crispy, fried favorites with up to 85% less fat than traditional deep frying. 8 one-touch cooking presets for effortless family meals.",
    features: [
  ...
  },
  {
    ...
    description:
      "The definitive guide to the architecture, trade-offs, and principles of modern data systems. Learn how to process, store, and scale distributed applications.",
    features: [
  ...
  },
  {
    ...
    description:
      "Read comfortably anywhere with a glare-free 300 ppi Paperwhite display that looks like real paper, even in bright sunlight.",
    features: [
  ...
  },
  {
    ...
    description:
      "Replace 5 sets of weights with one compact adjustable dumbbell. Quick-turn dial mechanism shifts weight instantly between 10 to 50 pounds.",
    features: [
  ...
  },
  {
    ...
    description:
      "Dual-sided textured surface provides exceptional grip and floor traction. 6mm thick eco-friendly TPE cushioning protects knees and joints.",
    features: [
